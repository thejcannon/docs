...
If you are using Mergify [merge queue](/merge-queue/intro) in projects where
there are frequent updates to a large number of small libraries, it's efficient
to batch these updates together. Using Mergify's merge queue feature, you can
