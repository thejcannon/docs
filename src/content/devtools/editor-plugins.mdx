...
<div style={{width: '80%', margin: '5%'}}>
  ![Using jump to definition on a fragment](../img/editors/jump-to-def.gif)
</div>
...
<div style={{width: '80%', margin: '5%'}}>
  ![Clicking the status bar icon to open the output pane](../img/editors/stats.gif)
</div>
## Features
...
<div style={{width: '80%', margin: '5%'}}>
  ![vscode completing a field when typing](../img/editors/autocomplete.gif)
</div>
...
<div style={{width: '80%', margin: '5%'}}>
  ![tooltip showing a field deprecation warning and error](../img/editors/warnings-and-errors.gif)
</div>
...
<div style={{width: '80%', margin: '5%'}}>
  ![a tooltip showing a Boolean type for a field](../img/editors/type-info.png)
</div>
...
<div style={{width: '80%', margin: '5%'}}>
  ![Performance annotation next to a field](../img/editors/perf-annotation.png)
</div>
### Syntax highlighting
