...
- [`pull_request_rules`](#pull-request-rules) configures [Automation
  Workflow](/workflow/writing-your-first-rule);

- [`queue_rules`](#queue-rules) configures the [Merge
  Queue](/merge-queue/intro);
...
[merge queues](/merge-queue/intro).
...
{/* FIXME: add link to the page when it's written + description */}
...
[Sharing](sharingsSharing-configuration-sections).
