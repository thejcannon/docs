...
<Screenshot src={rebaseScreenshot} />
...
<Warning>
  ...
  queue](/merge-queue/intro). A merge queue makes sure each pull request is
  up to date and retested before being merged, while avoiding to update all
