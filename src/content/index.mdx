...
import {FaCirclePlay, FaRegLightbulb, FaGear, FaTrafficLight, FaSnowflake, FaMoneyBill1} from 'react-icons/fa6';
import {AiOutlineStop, AiOutlinePartition, AiOutlineInteraction} from 'react-icons/ai';
