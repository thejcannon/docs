---
title: Using Mergify with stacked PRs
description: Learn how you can use Mergify with stacked PRs.
---

import { Info } from '../../../components/Alerts/Info';

Mergify supports stacked PRs with just a few configurations. This guide assumes
that you are familiar with the concept of [stacked
PRs](https://timothya.com/blog/git-stack).
