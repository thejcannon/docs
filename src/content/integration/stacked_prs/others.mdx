...
Mergify supports stacked PRs with just a few configurations. This guide assumes that you are familiar with the concept of [stacked PRs](https://timothya.com/blog/git-stack).
### Prerequisites
