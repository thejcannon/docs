...
import branchProtectionConditionsScreenshot from "../images/actions/merge/branch-protections-injection.png"
...
- Mergify does not merge pull request modifying its configuration file by default (see [`allow_merging_configuration_change`](merge#parameters) parameter).
